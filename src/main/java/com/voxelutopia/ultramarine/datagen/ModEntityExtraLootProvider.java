...
public class ModEntityExtraLootProvider implements LootTableSubProvider {
    ...
    public static final ResourceKey<LootTable> GOAT_EXTRA_DROP = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(MOD_ID, "entities/goat"));
    public static final ResourceKey<LootTable> FOX_EXTRA_DROP = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(MOD_ID, "entities/fox"));
    public static final ResourceKey<LootTable> RABBIT_EXTRA_DROP = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(MOD_ID, "entities/rabbit"));
