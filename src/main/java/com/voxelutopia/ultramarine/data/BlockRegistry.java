...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> GUNNY_SACK = BLOCKS.register("gunny_sack",
            () -> ContainerDecorativeBlock.with(BaseBlockProperty.WOOD).content(ContainerDecorativeBlock.ContainerType.FOOD_REGULAR).shaped(DecorativeBlock.CUBE_14).directional().build());
