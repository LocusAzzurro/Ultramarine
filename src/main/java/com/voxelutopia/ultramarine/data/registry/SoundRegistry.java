...
public class SoundRegistry {
    ...
    public static final ForgeSoundType PORCELAIN = new ForgeSoundType(1, 1,
            () -> SoundEvents.GLASS_BREAK, () -> SoundEvents.GLASS_STEP, () -> SoundEvents.GLASS_PLACE, () -> SoundEvents.GLASS_HIT, () -> SoundEvents.GLASS_FALL);
    // Copper not introduced in 1.16, use glass instead
