...
public class BlockRegistry {
    ...
    public static final DeferredHolder<Block, Block> CYAN_BRICKS = BLOCKS.register("cyan_bricks", BaseBlock::new);
    public static final DeferredHolder<Block, Block> CYAN_BRICK_SLAB = BLOCKS.register("cyan_brick_slab", () -> new BaseSlab((BaseBlock) CYAN_BRICKS.get()));
    public static final DeferredHolder<Block, Block> CYAN_BRICK_STAIRS = BLOCKS.register("cyan_brick_stairs", () -> new BaseStairs((BaseBlock) CYAN_BRICKS.get()));
    public static final DeferredHolder<Block, Block> CYAN_BRICK_WALL = BLOCKS.register("cyan_brick_wall", () -> new BaseWall((BaseBlock) CYAN_BRICKS.get()));

    public static final DeferredHolder<Block, Block> BLACK_BRICKS = BLOCKS.register("black_bricks", BaseBlock::new);
    public static final DeferredHolder<Block, Block> BLACK_BRICK_SLAB = BLOCKS.register("black_brick_slab", () -> new BaseSlab((BaseBlock) BLACK_BRICKS.get()));
    public static final DeferredHolder<Block, Block> BLACK_BRICK_STAIRS = BLOCKS.register("black_brick_stairs", () -> new BaseStairs((BaseBlock) BLACK_BRICKS.get()));
    public static final DeferredHolder<Block, Block> BLACK_BRICK_WALL = BLOCKS.register("black_brick_wall", () -> new BaseWall((BaseBlock) BLACK_BRICKS.get()));

    public static final DeferredHolder<Block, Block> BROWNISH_RED_STONE_BRICKS = BLOCKS.register("brownish_red_stone_bricks", BaseBlock::new);
    public static final DeferredHolder<Block, Block> BROWNISH_RED_STONE_BRICK_SLAB = BLOCKS.register("brownish_red_stone_brick_slab", () -> new BaseSlab((BaseBlock) BROWNISH_RED_STONE_BRICKS.get()));
    public static final DeferredHolder<Block, Block> BROWNISH_RED_STONE_BRICK_STAIRS = BLOCKS.register("brownish_red_stone_brick_stairs", () -> new BaseStairs((BaseBlock) BROWNISH_RED_STONE_BRICKS.get()));
    public static final DeferredHolder<Block, Block> BROWNISH_RED_STONE_BRICK_WALL = BLOCKS.register("brownish_red_stone_brick_wall", () -> new BaseWall((BaseBlock) BROWNISH_RED_STONE_BRICKS.get()));

    public static final DeferredHolder<Block, Block> WHITE_AND_PINK_MIXED_BRICKS = BLOCKS.register("white_and_pink_mixed_bricks", () -> new BaseBlock(BaseBlockProperty.STONE));
    public static final DeferredHolder<Block, Block> WHITE_AND_PINK_MIXED_BRICK_SLAB = BLOCKS.register("white_and_pink_mixed_brick_slab", () -> new BaseSlab((BaseBlock) WHITE_AND_PINK_MIXED_BRICKS.get()));
    public static final DeferredHolder<Block, Block> WHITE_AND_PINK_MIXED_BRICK_STAIRS = BLOCKS.register("white_and_pink_mixed_brick_stairs", () -> new BaseStairs((BaseBlock) WHITE_AND_PINK_MIXED_BRICKS.get()));
    public static final DeferredHolder<Block, Block> WHITE_AND_PINK_MIXED_BRICK_WALL = BLOCKS.register("white_and_pink_mixed_brick_wall", () -> new BaseWall((BaseBlock) WHITE_AND_PINK_MIXED_BRICKS.get()));

    public static final DeferredHolder<Block, Block> GREEN_WEATHERED_BRICKS = BLOCKS.register("green_weathered_bricks", () -> new BaseBlock(BaseBlockProperty.STONE));
    public static final DeferredHolder<Block, Block> GREEN_WEATHERED_BRICK_SLAB = BLOCKS.register("green_weathered_brick_slab", () -> new BaseSlab((BaseBlock) GREEN_WEATHERED_BRICKS.get()));
    public static final DeferredHolder<Block, Block> GREEN_WEATHERED_BRICK_STAIRS = BLOCKS.register("green_weathered_brick_stairs", () -> new BaseStairs((BaseBlock) GREEN_WEATHERED_BRICKS.get()));
    public static final DeferredHolder<Block, Block> GREEN_WEATHERED_BRICK_WALL = BLOCKS.register("green_weathered_brick_wall", () -> new BaseWall((BaseBlock) GREEN_WEATHERED_BRICKS.get()));

    // STONES

    public static final DeferredHolder<Block, Block> PALE_YELLOW_STONE = BLOCKS.register("pale_yellow_stone", BaseBlock::new);
    public static final DeferredHolder<Block, Block> PALE_YELLOW_STONE_SLAB = BLOCKS.register("pale_yellow_stone_slab", () -> new BaseSlab((BaseBlock) PALE_YELLOW_STONE.get()));
    public static final DeferredHolder<Block, Block> PALE_YELLOW_STONE_STAIRS = BLOCKS.register("pale_yellow_stone_stairs", () -> new BaseStairs((BaseBlock) PALE_YELLOW_STONE.get()));
    public static final DeferredHolder<Block, Block> VARIEGATED_ROCKS = BLOCKS.register("variegated_rocks", BaseBlock::new);
    public static final DeferredHolder<Block, Block> VARIEGATED_ROCK_SLAB = BLOCKS.register("variegated_rock_slab", () -> new BaseSlab((BaseBlock) VARIEGATED_ROCKS.get()));
    public static final DeferredHolder<Block, Block> VARIEGATED_ROCK_STAIRS = BLOCKS.register("variegated_rock_stairs", () -> new BaseStairs((BaseBlock) VARIEGATED_ROCKS.get()));
    public static final DeferredHolder<Block, Block> WEATHERED_STONE = BLOCKS.register("weathered_stone", BaseBlock::new);
    public static final DeferredHolder<Block, Block> WEATHERED_STONE_SLAB = BLOCKS.register("weathered_stone_slab", () -> new BaseSlab((BaseBlock) WEATHERED_STONE.get()));
    public static final DeferredHolder<Block, Block> WEATHERED_STONE_STAIRS = BLOCKS.register("weathered_stone_stairs", () -> new BaseStairs((BaseBlock) WEATHERED_STONE.get()));
    public static final DeferredHolder<Block, Block> POLISHED_WEATHERED_STONE = BLOCKS.register("polished_weathered_stone", BaseBlock::new);
    public static final DeferredHolder<Block, Block> POLISHED_WEATHERED_STONE_SLAB = BLOCKS.register("polished_weathered_stone_slab", () -> new BaseSlab((BaseBlock) POLISHED_WEATHERED_STONE.get()));
    public static final DeferredHolder<Block, Block> POLISHED_WEATHERED_STONE_STAIRS = BLOCKS.register("polished_weathered_stone_stairs", () -> new BaseStairs((BaseBlock) POLISHED_WEATHERED_STONE.get()));
    public static final DeferredHolder<Block, Block> POLISHED_WEATHERED_STONE_WALL = BLOCKS.register("polished_weathered_stone_wall", () -> new BaseWall((BaseBlock) POLISHED_WEATHERED_STONE.get()));
    ...
    public static final DeferredHolder<Block, Block> LIGHT_CYAN_FLOOR_TILE = BLOCKS.register("light_cyan_floor_tile", () -> new BaseBlock(BaseBlockProperty.TILE));
    public static final DeferredHolder<Block, Block> LIGHT_CYAN_FLOOR_TILE_SLAB = BLOCKS.register("light_cyan_floor_tile_slab", () -> new BaseSlab((BaseBlock) LIGHT_CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> LIGHT_CYAN_FLOOR_TILE_STAIRS = BLOCKS.register("light_cyan_floor_tile_stairs", () -> new BaseStairs((BaseBlock) LIGHT_CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> LIGHT_CYAN_FLOOR_TILE_WALL = BLOCKS.register("light_cyan_floor_tile_wall", () -> new BaseWall((BaseBlock) LIGHT_CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> CYAN_FLOOR_TILE = BLOCKS.register("cyan_floor_tile", () -> new BaseBlock(BaseBlockProperty.TILE));
    public static final DeferredHolder<Block, Block> CYAN_FLOOR_TILE_SLAB = BLOCKS.register("cyan_floor_tile_slab", () -> new BaseSlab((BaseBlock) CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> CYAN_FLOOR_TILE_STAIRS = BLOCKS.register("cyan_floor_tile_stairs", () -> new BaseStairs((BaseBlock) CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> CYAN_FLOOR_TILE_WALL = BLOCKS.register("cyan_floor_tile_wall", () -> new BaseWall((BaseBlock) CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> DARK_CYAN_FLOOR_TILE = BLOCKS.register("dark_cyan_floor_tile", () -> new BaseBlock(BaseBlockProperty.STONE));
    public static final DeferredHolder<Block, Block> DARK_CYAN_FLOOR_TILE_SLAB = BLOCKS.register("dark_cyan_floor_tile_slab", () -> new BaseSlab((BaseBlock) DARK_CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> DARK_CYAN_FLOOR_TILE_STAIRS = BLOCKS.register("dark_cyan_floor_tile_stairs", () -> new BaseStairs((BaseBlock) DARK_CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> DARK_CYAN_FLOOR_TILE_WALL = BLOCKS.register("dark_cyan_floor_tile_wall", () -> new BaseWall((BaseBlock) DARK_CYAN_FLOOR_TILE.get()));
    ...
    public static final DeferredHolder<Block, Block> WEATHERED_RED_STONE_TILE_SLAB = BLOCKS.register("weathered_red_stone_tile_slab", () -> new BaseSlab((BaseBlock) DARK_CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> WEATHERED_RED_STONE_TILE_STAIRS = BLOCKS.register("weathered_red_stone_tile_stairs", () -> new BaseStairs((BaseBlock) DARK_CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> WEATHERED_RED_STONE_TILE_WALL = BLOCKS.register("weathered_red_stone_tile_wall", () -> new BaseWall((BaseBlock) DARK_CYAN_FLOOR_TILE.get()));
    ...
    public static final DeferredHolder<Block, Block> BLUE_AND_BLACK_TILE_SLAB = BLOCKS.register("blue_and_black_tile_slab", () -> new BaseSlab((BaseBlock) DARK_CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> BLUE_AND_BLACK_TILE_STAIRS = BLOCKS.register("blue_and_black_tile_stairs", () -> new BaseStairs((BaseBlock) DARK_CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> BLUE_AND_BLACK_TILE_WALL = BLOCKS.register("blue_and_black_tile_wall", () -> new BaseWall((BaseBlock) DARK_CYAN_FLOOR_TILE.get()));
    public static final DeferredHolder<Block, Block> GREEN_GLAZED_TILES = BLOCKS.register("green_glazed_tiles", () -> new BaseBlock(BaseBlockProperty.GLAZED));
    public static final DeferredHolder<Block, Block> GREEN_GLAZED_TILE_SLAB = BLOCKS.register("green_glazed_tile_slab", () -> new BaseSlab((BaseBlock) GREEN_GLAZED_TILES.get()));
    public static final DeferredHolder<Block, Block> GREEN_GLAZED_TILE_STAIRS = BLOCKS.register("green_glazed_tile_stairs", () -> new BaseStairs((BaseBlock) GREEN_GLAZED_TILES.get()));
    ...
    public static final DeferredHolder<Block, Block> ROSEWOOD_PLANKS = BLOCKS.register("rosewood_planks", () -> new BaseBlock(BaseBlockProperty.WOOD));
    public static final DeferredHolder<Block, Block> ROSEWOOD_SLAB = BLOCKS.register("rosewood_slab", () -> new BaseSlab((BaseBlock) ROSEWOOD_PLANKS.get()));
    public static final DeferredHolder<Block, Block> ROSEWOOD_STAIRS = BLOCKS.register("rosewood_stairs", () -> new BaseStairs((BaseBlock) ROSEWOOD_PLANKS.get()));
    public static final DeferredHolder<Block, Block> ROSEWOOD_FENCE = BLOCKS.register("rosewood_fence", () -> new BaseFence((BaseBlock) ROSEWOOD_PLANKS.get()));
    ...
    public static final DeferredHolder<Block, Block> BAMBOO_MAT = BLOCKS.register("bamboo_mat", () -> new BaseBlock(BaseBlockProperty.BAMBOO_WOOD));
    public static final DeferredHolder<Block, Block> BAMBOO_MAT_SLAB = BLOCKS.register("bamboo_mat_slab", () -> new BaseSlab((BaseBlock) BAMBOO_MAT.get()));
    public static final DeferredHolder<Block, Block> BAMBOO_MAT_STAIRS = BLOCKS.register("bamboo_mat_stairs", () -> new BaseStairs((BaseBlock) BAMBOO_MAT.get()));
    ...
    public static final DeferredHolder<Block, Block> JADE_BLOCK = BLOCKS.register("jade_block", BaseBlock::new);
    public static final DeferredHolder<Block, Block> BRONZE_BLOCK = BLOCKS.register("bronze_block", BaseBlock::new);
