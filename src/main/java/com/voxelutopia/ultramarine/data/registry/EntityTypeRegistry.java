...
public class EntityTypeRegistry {
    ...
    public static final ResourceKey<EntityType<?>> seatKey = ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(Ultramarine.MOD_ID, "seat"));
    public static final ResourceKey<EntityType<?>> merchantKey = ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(Ultramarine.MOD_ID, "travelling_merchant"));
    public static final DeferredHolder<EntityType<?>, EntityType<SeatEntity>> SEAT =
            register("seat", () -> EntityType.Builder
                    .<SeatEntity>of(SeatEntity::new, MobCategory.MISC).sized(0.1f, 0.1f).build(seatKey));
    public static final DeferredHolder<EntityType<?>, EntityType<TravellingMerchant>> TRAVELLING_MERCHANT =
            register("travelling_merchant", () -> EntityType.Builder
                    .of(TravellingMerchant::new, MobCategory.CREATURE).sized(0.6f, 2.0f).build(merchantKey));
