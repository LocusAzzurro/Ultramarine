...
public class ContainerDecorativeBlockMenu extends AbstractContainerMenu {
    ...
    public static ContainerDecorativeBlockMenu genericOneRow(int pId, Inventory pPlayer) {
        return new ContainerDecorativeBlockMenu(ModMenuTypes.CONTAINER_DECORATIVE_BLOCK_MENU_GENERIC_9X1, pId, pPlayer, ContainerType.COMMON_SMALL);
    }

    public static ContainerDecorativeBlockMenu genericThreeRows(int pId, Inventory pPlayer) {
        return new ContainerDecorativeBlockMenu(ModMenuTypes.CONTAINER_DECORATIVE_BLOCK_MENU_GENERIC_9X3, pId, pPlayer, ContainerType.COMMON_REGULAR);
    }

    public static ContainerDecorativeBlockMenu genericSixRows(int pId, Inventory pPlayer) {
        return new ContainerDecorativeBlockMenu(ModMenuTypes.CONTAINER_DECORATIVE_BLOCK_MENU_GENERIC_9X6, pId, pPlayer, ContainerType.COMMON_LARGE);
    }

    public static ContainerDecorativeBlockMenu foodThreeRows(int pId, Inventory pPlayer) {
        return new ContainerDecorativeBlockMenu(ModMenuTypes.CONTAINER_DECORATIVE_BLOCK_MENU_FOOD_9X3, pId, pPlayer, ContainerType.FOOD_REGULAR);
    }

    public static ContainerDecorativeBlockMenu foodSixRows(int pId, Inventory pPlayer) {
        return new ContainerDecorativeBlockMenu(ModMenuTypes.CONTAINER_DECORATIVE_BLOCK_MENU_FOOD_9X6, pId, pPlayer, ContainerType.FOOD_LARGE);
    }

    public static ContainerDecorativeBlockMenu genericOneRow(int pId, Inventory pPlayer, Container pBlockEntity) {
        return new ContainerDecorativeBlockMenu(ModMenuTypes.CONTAINER_DECORATIVE_BLOCK_MENU_GENERIC_9X1, pId, pPlayer, pBlockEntity, ContainerType.COMMON_SMALL);
    }

    public static ContainerDecorativeBlockMenu genericThreeRows(int pId, Inventory pPlayer, Container pBlockEntity) {
        return new ContainerDecorativeBlockMenu(ModMenuTypes.CONTAINER_DECORATIVE_BLOCK_MENU_GENERIC_9X3, pId, pPlayer, pBlockEntity, ContainerType.COMMON_REGULAR);
    }

    public static ContainerDecorativeBlockMenu genericSixRows(int pId, Inventory pPlayer, Container pBlockEntity) {
        return new ContainerDecorativeBlockMenu(ModMenuTypes.CONTAINER_DECORATIVE_BLOCK_MENU_GENERIC_9X6, pId, pPlayer, pBlockEntity, ContainerType.COMMON_LARGE);
    }

    public static ContainerDecorativeBlockMenu foodThreeRows(int pId, Inventory pPlayer, Container pBlockEntity) {
        return new ContainerDecorativeBlockMenu(ModMenuTypes.CONTAINER_DECORATIVE_BLOCK_MENU_FOOD_9X3, pId, pPlayer, pBlockEntity, ContainerType.FOOD_REGULAR);
    }

    public static ContainerDecorativeBlockMenu foodSixRows(int pId, Inventory pPlayer, Container pBlockEntity) {
        return new ContainerDecorativeBlockMenu(ModMenuTypes.CONTAINER_DECORATIVE_BLOCK_MENU_FOOD_9X6, pId, pPlayer, pBlockEntity, ContainerType.FOOD_LARGE);
    }
